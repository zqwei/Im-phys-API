...
if ~exist([PlotDir 'ModeledSingleUnitsAnova'],'dir')
    mkdir([PlotDir 'ModeledSingleUnitsAnova'])
end
...
%     save([TempDatDir 'ModeledLogPValue_' DataSetList(nData).name '.mat'], 'logPValue')
%     logPValueEpoch= getLogPValueSpikeEpoch(nDataSet, DataSetList(nData).params);
%     save([TempDatDir 'ModeledLogPValue_' DataSetList(nData).name '.mat'], 'logPValueEpoch', '-append')
    ...
    setPrint(10, 6*4, [PlotDir 'ModeledSingleUnitsAnova/SingleUnitsAnova_' DataSetList(nData).name], 'tiff')
...
%     xlabel('Depth (um)')
    ...
    setPrint(8*2, 6, [PlotDir 'ModeledSingleUnitsAnova/SingleUnitsAnovaDepth_' DataSetList(nData).name], 'pdf')
end
