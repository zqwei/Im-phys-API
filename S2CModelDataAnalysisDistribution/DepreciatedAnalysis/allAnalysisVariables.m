...
for nData         = 1:2
    for nParaSet  = 1:900
        load([TempDatDir dataSetNames{nData} num2str(nParaSet, '%03d') '.mat'])    
        ...
        save([TempDatDir 'Results_' dataSetNames{nData} num2str(nParaSet, '%03d') '.mat'], 'sizeGroup', 'countMaxId', 'peakiness', 'PCAVar', 'decodability')
    end
end