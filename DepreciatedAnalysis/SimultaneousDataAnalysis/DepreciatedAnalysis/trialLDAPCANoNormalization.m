...
for nData             =1:length(DataSetList)
    ...
    load([TempDatDir 'SimultaneousPCA_' DataSetList(nData).name '.mat'], 'coeffPCs')
    ...
    setPrint(8*m, 6*m, [PlotDir 'SimultaneousUnitsPCALDACorr/SimilarityLDAPCANONormalization_' DataSetList(nData).name], 'tif')
end
