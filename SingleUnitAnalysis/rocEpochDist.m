...
for nData             = 1:length(DataSetList)-1
    ...
    set(gca, 'TickDir', 'out')
    setPrint(8, 6, [PlotDir 'SingleUnitsROC/SingleUnitsROC_' DataSetList(nData).name], 'svg')
end
...
for nData             = 1:length(DataSetList)-1
    ...
    set(gca, 'TickDir', 'out')
    setPrint(8, 6, [PlotDir 'SingleUnitsROC/SingleActUnitsROC_' DataSetList(nData).name], 'svg')
end
...
%     setPrint(8, 6, [PlotDir 'SingleUnitsROC/SingleActUnitsROCNoAcc_' DataSetList(nData).name], 'svg')
% end
