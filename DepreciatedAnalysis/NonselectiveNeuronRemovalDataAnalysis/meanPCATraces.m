...
for nData              = [1 3 4]
    ...
    firingRates        = generateDPCAData(nDataSet(unitGroup>0), numTrials);
...
%     setPrint(8*3, 6, [PlotDir 'CollectedUnitsPCA/CollectedUnitsPCATrace_' DataSetList(nData).name '_withOLRemoval'])
...
%     end
%     
%     setPrint(8*3, 6, [PlotDir 'CollectedUnitsPCA/CollectedUnitsPCALOCThresTrace_' DataSetList(nData).name '_withOLRemoval'])
%     
% end
% 
% close all