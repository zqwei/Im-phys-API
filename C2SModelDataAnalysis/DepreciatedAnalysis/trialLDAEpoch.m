...
if ~exist([PlotDir '/ModeledCollectedUnitsDecodabilityEpoch'],'dir')
    mkdir([PlotDir '/ModeledCollectedUnitsDecodabilityEpoch'])
end
...
for nData           = 1:length(DataSetList)
    ...
    setPrint(8, 6, [PlotDir 'ModeledCollectedUnitsDecodabilityEpoch/CollectedUnitsDecodabilityEpoch_' DataSetList(nData).name], 'pdf')
end
