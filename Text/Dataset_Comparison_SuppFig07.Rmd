...
### Supplementary Figure `r figIndex`f -- calcium to spike model (linear model)

### Supplementary Figure `r figIndex`g -- PC traces
```{r}
source('Dataset_Comparison_Funcs.R')
...
ImageDir <- 'S2CModel/CollectedUnitsPCATrace_'
