...
function plotMeanActivityImagescWithLocation (nDataSet, params, cellinfo)    
    blankSpace = 10;
    ...
    pyrmidal_cell_index           = cell2mat(arrayfun(@(x) strcmp(x.cellType, 'putative_pyramidal'),...
                                                cellinfo, 'OutputUniform', false));
                                            
    actMat                        = actMat(pyrmidal_cell_index, :);
