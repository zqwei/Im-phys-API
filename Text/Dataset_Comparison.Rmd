...
ImageDir <- 'Plot/SingleUnitsImagescWithSort/SingleUnitsImagescRasterOnly_'
...
```{r}
source('Dataset_Comparison_Funcs.R')
ImageDir <- 'Plot/SingleUnitsTscore/SingleUnitsTscore_'
includeHtmlMD(ImageDir)
```
...
```{r}
source('Dataset_Comparison_Funcs.R')
ImageDir <- 'Plot/SingleUnitsROC/SingleActUnitsROC_'
includeHtmlMD(ImageDir, fileType = 'pdf')
```
