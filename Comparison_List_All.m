...
ephysCellIndex{nData}        = [DataSetList(nData).cellinfo(:).depth]  > 120 &...
                           ...
                           [DataSetList(nData).cellinfo(:).ML_axis]  < 1700;                        
% ephysCellIndex{nData}        = [DataSetList(nData).cellinfo(:).ML_axis]  > 1100 &...
...
ephysCellIndex{nData}  = [DataSetList(nData).cellinfo(:).depth]  > 120 &...
                       [DataSetList(nData).cellinfo(:).depth]  < 750 & ...
                       [DataSetList(nData).cellinfo(:).AP_axis]  > 2400 &...
                       [DataSetList(nData).cellinfo(:).AP_axis]  < 2800 &...
                       [DataSetList(nData).cellinfo(:).ML_axis]  > 1100 &...
                       [DataSetList(nData).cellinfo(:).ML_axis]  < 1700; 
...
fileToAnalysis                = [1 5]; % 1:length(DataSetList);                   
...
run Simultaneous_Data_Code/Comparison_V1_10_1.m
% 
