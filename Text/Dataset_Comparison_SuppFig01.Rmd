...
### Supplementary Figure `r figIndex`b -- Fraction of dynamical-selective neurons is distributed similarly at different AP-ML locations
...
### Supplementary Figure `r figIndex`c -- Fraction of dynamical-selective neurons is distributed similarly across different animals
<!-- Add statistical test, p-value, maybe sharable r code; statistical table like number of neurons in each condition -->
```{r}
