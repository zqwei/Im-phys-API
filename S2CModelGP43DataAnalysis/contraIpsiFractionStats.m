...
meanContraIndexData = [0.4712, 0.6069, 0.5703, 0.5590, 0.5424];
stdContraIndexData  = [0.0367, 0, 0.0298, 0.0316, 0.0320];
...
ylabel('Frac. Contra')
box off;
setPrint(8, 6, [PlotDir 'S2CGP43Model/ContraFraction'])