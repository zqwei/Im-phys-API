...
for nData           = 1:length(DataSetList)
    ...
    setPrint(8, 6, [PlotDir 'S2CModel/CollectedUnitsDecodabilityEpoch_0_5_' DataSetList(nData).name])
end
...
for nData           = 1:length(DataSetList)
    ...
    setPrint(8, 6, [PlotDir 'S2CModel/CollectedUnitsDecodabilityEpoch_0_7_' DataSetList(nData).name])
end
