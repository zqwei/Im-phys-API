...
ylabel('Prob. Density')
setPrint(8, 6, [PlotDir 'ConfoundingFactorFPVT/SingleUnitsFPVTAPML_' DataSetList(nData).name], 'pdf')
...
for nData          = DataSetToAnalysis
    ...
    xlabel('First P Val. time (ms)')
    ylabel('Prob. Density')
    setPrint(8, 6, [PlotDir 'ConfoundingFactorFPVT/SingleUnitsFPVTANM_' DataSetList(nData).name], 'pdf')
end
