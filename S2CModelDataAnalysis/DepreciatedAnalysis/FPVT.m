...
if ~exist([PlotDir 'ModeledSingleUnitsFPVT'],'dir')
    mkdir([PlotDir 'ModeledSingleUnitsFPVT'])
end
...
%     colorbar;
    ...
    ylabel('Neuron Index')
    box off;
    setPrint(8, 6, [PlotDir 'ModeledSingleUnitsFPVT/SingleUnitsZScore_' DataSetList(nData).name], 'pdf')
...
%     uniqueDepth                  = unique(depth);
    ...
    setPrint(8*2, 6, [PlotDir 'ModeledSingleUnitsFPVT/SingleUnitsFPVTDepth_' DataSetList(nData).name], 'pdf')
end
