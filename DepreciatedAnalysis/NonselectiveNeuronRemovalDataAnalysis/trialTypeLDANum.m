...
for nData             = [3 4]
    ...
    colormap(cmap)
    set(gca, 'TickDir', 'out')
    setPrint(8, 6, [PlotDir 'CollectedUnitsDecodability/CollectedUnitsDecodabilityFixedROCThres_0_5_' DataSetList(nData).name '_withOLRemoval'])
end
...
for nData             = [3 4]
    ...
    colormap(cmap)
    set(gca, 'TickDir', 'out')
    setPrint(8, 6, [PlotDir 'CollectedUnitsDecodability/CollectedUnitsDecodabilityFixedROCThres_0_7_' DataSetList(nData).name '_withOLRemoval'])
end
