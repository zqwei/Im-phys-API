...
```{r}
ImageDir <- 'Plot/SingleUnitsTscore/SingleUnitsTscoreDepth_'
...
ImageDir <- 'Plot/ConfoundingFactorTscore/SingleUnitsTscoreAPML_'
source('Dataset_Comparison_Funcs.R')
...
ImageDir = 'Plot/ConfoundingFactorTscore/SingleUnitsTscoreANM_'
source('Dataset_Comparison_Funcs.R')
