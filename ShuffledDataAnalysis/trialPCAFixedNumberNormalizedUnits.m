...
for nData              = 1:length(DataSetList)-1
    ...
    save([TempDatDir 'PCATimeFixed' num2str(currNumUnits) 'NormalizedUnits_' DataSetList(nData).name '.mat'], 'pcaVar', 'evTrialType')
    ...
    setPrint(8*2, 6, [PlotDir 'CollectedUnitsPCA/CollectedUnitsPCAFixed' num2str(currNumUnits) 'NormalizedUnits_' DataSetList(nData).name], 'pdf')
end
