...
function nDataSet = getFakeCaImagingDataSigmoidNL(spikeDataSet, params)
    ...
    for nData          = 1:length(spikeDataSet)
        ...
        if rMean == 0; rMean = rand(); end
        nDataSet(nData).unit_yes_trial           = spikeTimeToImagingSigmoidNL(spikeDataSet(nData).unit_yes_trial_spk_time, timeSeriesData, paramsSet, rMean);
        nDataSet(nData).unit_yes_trial_index     = spikeDataSet(nData).unit_yes_trial_index;
        nDataSet(nData).unit_no_trial            = spikeTimeToImagingSigmoidNL(spikeDataSet(nData).unit_no_trial_spk_time, timeSeriesData, paramsSet, rMean);
        nDataSet(nData).unit_no_trial_index      = spikeDataSet(nData).unit_no_trial_index;
        nDataSet(nData).unit_yes_trial           = nDataSet(nData).unit_yes_trial + F0 + randn(size(nDataSet(nData).unit_yes_trial))*constNoise;
        nDataSet(nData).unit_no_trial            = nDataSet(nData).unit_no_trial  + F0 + randn(size(nDataSet(nData).unit_no_trial))*constNoise;
    
        nDataSet(nData).unit_yes_error           = spikeTimeToImagingSigmoidNL(spikeDataSet(nData).unit_yes_error_spk_time, timeSeriesData, paramsSet, rMean);
        nDataSet(nData).unit_yes_error_index     = spikeDataSet(nData).unit_yes_error_index;
        nDataSet(nData).unit_no_error            = spikeTimeToImagingSigmoidNL(spikeDataSet(nData).unit_no_error_spk_time, timeSeriesData, paramsSet, rMean);
        nDataSet(nData).unit_no_error_index      = spikeDataSet(nData).unit_no_error_index;  
        nDataSet(nData).unit_yes_error           = nDataSet(nData).unit_yes_error + F0 + randn(size(nDataSet(nData).unit_yes_error))*constNoise;
        nDataSet(nData).unit_no_error            = nDataSet(nData).unit_no_error + F0 + randn(size(nDataSet(nData).unit_no_error))*constNoise;
