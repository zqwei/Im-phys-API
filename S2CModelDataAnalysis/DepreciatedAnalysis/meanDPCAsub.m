...
for nData              = 1:length(DataSetList)
    ...
    setPrint(8*3, 6, [PlotDir 'ModeledCollectedUnitsdPCA/CollectedSubUnitsdPCA_' DataSetList(nData).name], 'pdf')
    ...
    set(gca,'xTick', 0:5:numComps)
    ylabel('% EV per PC')
    setPrint(8, 6, [PlotDir 'ModeledCollectedUnitsdPCA/CollectedSubUnitsPCA_' DataSetList(nData).name], 'pdf')
