...
contraFrac = [29/76, 105/140];
ipsiFrac = [49/110, 79/100];
figure;
hold on
...
box off;
set(gca, 'TickDir', 'out')
setPrint(6, 6, [PlotDir 'SingleUnitsRampingDown/ContraFractionRampDownUpLongDecay'])
...
set(gca, 'TickDir', 'out')
box off;
setPrint(6, 6, [PlotDir 'SingleUnitsRampingDown/ContraFractionRampDownUpShortDecay'])
