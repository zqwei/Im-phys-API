...
for nData              = 1:length(DataSetList)
    ...
    for nSession      = 1:length(nDataSet)
        ...
        setPrint(12*2, 9, [PlotDir 'SimultaneousUnitsPCA/SimultaneousNormalizedUnitsPCA_' DataSetList(nData).name  '_Session_' num2str(nSession, '%02d')], 'pdf')
        
    end
    
    
    
    save([TempDatDir 'SimultaneousNormalizedPCA_' DataSetList(nData).name '.mat'], 'coeffPCs', 'pcaVars', 'evTrialTypes')
end
