...
for nData             = [1 3 4]
    ...
    colormap(cmap)
    set(gca, 'TickDir', 'out')
    setPrint(8, 6, [PlotDir 'CollectedUnitsPCALDACorr/SimilarityLDALDA_100_' DataSetList(nData).name])
end
...
for nData             = [1 3 4]
    ...
    colormap(cmap)
    set(gca, 'TickDir', 'out')
    setPrint(8, 6, [PlotDir 'CollectedUnitsPCALDACorr/SimilarityLDALDA_500_' DataSetList(nData).name])
end
