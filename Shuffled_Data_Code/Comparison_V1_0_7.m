...
for nData                     = fileToAnalysis
    ...
    legendString(fileToAnalysis==nData) = {[strrep(DataSetList(nData).name(9:end),'_',' '), ': ', num2str(sum(nCell)) ' cells']}; 
end
...
setPrint(8, 6, [PlotDir 'All_Data_Summary/Cropped_Data_FPVT'], 'pdf')