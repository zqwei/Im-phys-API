...
%     save([TempDatDir 'LogPValue_' DataSetList(nData).name '.mat'], 'logPValueEpoch', '-append')
    ...
    unitGroup = getAnovaLogPSpikeEpochRewardOnly(logPValueEpoch);
    ...
    figure
    groupNames      = {'Stimulus', 'Outcome', 'Mixed', 'Non'};
...
%     colormap(cmap)
    setPrint(8, 6, [PlotDir 'SingleUnitsAnova/SingleUnitsAnovaRewardOnly_' DataSetList(nData).name])
