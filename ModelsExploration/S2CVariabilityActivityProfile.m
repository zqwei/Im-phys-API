...
% varNParams      = nan(length(nDataSet), length(nKeys)+1, 2);
% 
...
%         varNParams(nNeuron, nParams+1, :) = varChangeParams(spikeDataSet, params, nKeys{nParams});
%     end
% 
%     varNParams(nNeuron, 1, :)   = varChangeBaseline(spikeDataSet, params);
%    
% end
% 
...
function varNParams = varChangeBaseline(spikeDataSet, params)
