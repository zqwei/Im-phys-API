...
if ~exist([PlotDir 'ModeledCollectedUnitsPCA'],'dir')
    mkdir([PlotDir 'ModeledCollectedUnitsPCA'])
end
...
%     title('frac. PC Variance')
    colorbar
    setPrint(8, 6, [PlotDir 'ModeledCollectedUnitsPCA/CollectedUnitsPCAFracVar_' DataSetList(nData).name], 'pdf')
...
%     title('PC Trial Type EV')
    ...
    setPrint(8, 6, [PlotDir 'ModeledCollectedUnitsPCA/CollectedUnitsPCATrialEV_' DataSetList(nData).name], 'pdf')
