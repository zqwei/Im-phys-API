...
options = struct('numComps',       25,                  ...   
                 'lambdas',        1e-07 * 1.5.^[0:40], ... %default: 1e-07 * 1.5.^[0:25]
                 'numRep',         10,                  ...
                 'display',        'yes',               ...
                 'combinedParams', [],                  ...
                 'filename',       [],                  ...
...
if strcmp(options.display, 'yes')
    ...
    xticks = [1e-07:1e-07:1e-06 2e-06:1e-06:1e-05 2e-05:1e-05:1e-04 2e-04:1e-04:1e-03 2e-03:1e-03:1e-02 2e-02:1e-02:1e-01 2e-01:1e-01:1 2:10];
    xtickLabels = num2cell(xticks);
    for i=setdiff(1:length(xticks), [1 10 19 28 37 46 55 64 73 82 91])
        xtickLabels{i} = '';
    end
    ...
    plot(xlim, [1 1], 'k')
    axis([log(options.lambdas(1)) log(options.lambdas(end)) 0 4])
end
