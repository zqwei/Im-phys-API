...
for nData             = 1:length(DataSetList)
    ...
    colormap(cmap)
    set(gca, 'TickDir', 'out')
    setPrint(8, 6, [PlotDir 'C2SModel/CollectedUnitsDecodabilityFixedROCThres_0_5_' DataSetList(nData).name])
end
...
for nData             = 1:length(DataSetList)
    ...
    colormap(cmap)
    set(gca, 'TickDir', 'out')
    setPrint(8, 6, [PlotDir 'C2SModel/CollectedUnitsDecodabilityFixedROCThres_0_7_' DataSetList(nData).name])
end
